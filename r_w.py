...
def calculate_clw():
    ...
    # in progess: right now just a dummy function with a constant clw in correct formatting
    clw = 0.12
    clw_str = " " + str(clw)
...
if __name__ == '__main__':
    ...
    pave=[]        # average pressure of current layer
    tave=[]        # average temperature of current layer
    altbot=[]    # altitude for bottom of current layer
    alttop=[]    # altitude for top of current layer
    pbot=[]        # pressure at altbot
    tbot=[]        # temperature at altbot
    ptop=[]        # pressure at alttop
    ttop=[]        # temperature at alttop
    # own parameters:
    lwp=[]        # integrated liquid water path
    cldbot=[]    # altitude of cloud bottom
    cldtop=[]    # altitude of cloud top
    # to be calculated:
    clw=[]        # cloud liquid water per layer
    # ###############################################
